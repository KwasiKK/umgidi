 ...
 */
define('URL', 'http://localhost:81/umgidi/');
define('UPLOAD_URL', '/voxin/public/umgidi/');
/**
...
define("EMAIL_PASSWORD_RESET_FROM_NAME", "BBB Smart Store");
define("EMAIL_PASSWORD_RESET_SUBJECT", "Password reset for Blueberry Bee Smart Store App");
define("EMAIL_PASSWORD_RESET_CONTENT", "Please click on this link to reset your password: ");

define("EMAIL_VERIFICATION_URL", URL . "login/verify");
define("EMAIL_VERIFICATION_FROM_EMAIL", "no-reply@example.com");
define("EMAIL_VERIFICATION_FROM_NAME", "BBB Smart Store");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for Blueberry Bee Smart Store App");
define("EMAIL_VERIFICATION_CONTENT", "Please click on this link to activate your account: ");
